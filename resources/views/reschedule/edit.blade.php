    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 border-b-2 fixed z-50 top-0 w-full">
        <div class="max-w-screen-xl flex flex-wrap items-center mx-auto p-4">
            ...
            <div class="hidden w-full ml-8 mt-1 md:block md:w-auto" id="navbar-default">
                ...
                <li>
                    <a href="/presensi" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Presence</a>
                </li>
                <li>
                ...
                <li>
                    <a href="#" class="block py-2 px-3 text-blue-700 rounded underline underline-offset-[34px] hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Re schedule</a>
                </li>
                </ul>
            </div>
        </div>
